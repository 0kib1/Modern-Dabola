-- Last Modified 10/11/2022 - Dread: Added a load of peace based defines, tweaked for fine tuning of AI peace deals
	...
	NDefines.NMilitary.CORPS_COMMANDER_DIVISIONS_CAP = 25 -- Vanilla 24
	NDefines.NMilitary.FIELD_MARSHAL_DIVISIONS_CAP = 30 --24
	...
	NDefines.NMilitary.NAVAL_EQUIPMENT_BASE_COST = 0 -- 25
	...
	NDefines.NMilitary.UNIT_LEADER_ASSIGN_TRAIT_COST = 5.0 -- 15
